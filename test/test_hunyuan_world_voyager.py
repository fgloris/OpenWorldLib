...
interaction_sequence = ["forward", "backward", "camera_l"] # can also be a single interaction
output_video = pipeline(images=input_image, interactions=interaction_sequence, prompt=test_prompt)
