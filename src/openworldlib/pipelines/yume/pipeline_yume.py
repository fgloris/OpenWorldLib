...
from ...memories.visual_synthesis.yume.yume_memory import YumeMemory
...
class YumePipeline:
    ...
    def __init__(
        self,
        synthesis_model: Optional[YumeSynthesis] = None,
        operators: Optional[YumeOperator] = None,
    ...
    def from_pretrained(
        ...
        if model_path is None:
            synthesis_model_path = "stdstu123/Yume-I2V-540P"
        else:
